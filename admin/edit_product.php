...
if (isset($_GET['product_id'])) {
  ...
  $stmt = $conn->prepare("UPDATE products SET product_name=?, product_description=?, video=?, product_category=?  WHERE product_id=?");
  $stmt->bind_param('ssssi', $title, $description, $video, $category, $product_id);
      ...
      <div class="table-responsive">
        <div class="mx-auto container">
          <form id="edit-form" method="POST" action="edit_product.php">
            ...
            <div class="form-group mt-2">
              <label>Відео</label>
              <input type="text" class="form-control" value="<?php echo $product['video'] ?>" id="video" name="video" placeholder="video" required />
            </div>
